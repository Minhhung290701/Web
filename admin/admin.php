    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="?admin=hienthihd" class="waves-effect"><i class="fa fa-vcard-o m-r-10" aria-hidden="true"></i>Quản lý Hóa Đơn</a>
                        </li>
                        <li>
                            <a href="?admin=hienthind" class="waves-effect"><i class="fa fa-user m-r-10" aria-hidden="true"></i>Quản lý Người Dùng</a>
                        </li>
                        <li>
                            <a href="?admin=hienthitt" class="waves-effect"><i class="fa fa-columns m-r-10" aria-hidden="true"></i>Quản lý Tin Tức</a>
                        </li>
                        <li>
                            <a href="?admin=hienthiht" class="waves-effect"><i class="fa fa-envelope-open-o m-r-10" aria-hidden="true"></i>Quản lý Hỗ Trợ</a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                ©  Admin by- <a href="https://www.facebook.com/minh.hung.09.04"> Minh Hùng</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->

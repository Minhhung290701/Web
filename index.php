	...
	<div id="footer">
		...
		<div id="bg-footer">
			...
			<div id="lg-footer">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">HT Mobile Shop</span></li> <br>
						
						<li>Địa chỉ: UET-Đại học quốc gia Hà Nội </li>
				...
				<div id="copyright">
					<p>Sinh Viên : Tăng Văn Minh Hùng | Lê Văn Sơn | Lớp : INT3202_5 | Giảng viên: Nguyễn Thị Hậu <p>
				</div><!-- End .copyright -->
